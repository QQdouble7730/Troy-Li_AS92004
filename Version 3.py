...
questions = {
    ...
    "Which song was Takamatsu Tomori's first attempt at writing lyrics?": ["A. 𝑨 𝒔𝒐𝒏𝒈 𝒂𝒃𝒐𝒖𝒕 𝒘𝒂𝒏𝒕𝒊𝒏𝒈 𝒕𝒐 𝒃𝒆𝒄𝒐𝒎𝒆 𝒉𝒖𝒎𝒂𝒏", "B. 𝑯𝒂𝒓𝒖𝒉𝒊𝒌𝒂𝒈𝒆 (𝑺𝒑𝒓𝒊𝒏𝒈 𝑺𝒖𝒏𝒍𝒊𝒈𝒉𝒕)", "C. "]
}
...
if a == "yes":
    print("Your answer:")
    print (list)
    print("The correct answer:A, B, A, C, A, D, C, A, D, B, C")
else:
    exit()
