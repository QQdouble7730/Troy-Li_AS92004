...
questions = {
    ...
    "9. Which of the following statements is correct?": ["A. Chihaya Anon has never met Togawa Sakiko.", "B. Shiina Taki has never met", "C. has never met", "D. has never met"]
}
...
if a == "yes":
    print("Your answer:")
    print (list)
    print("The correct answer:A,B,A,C,A,D")
else:
    exit()
